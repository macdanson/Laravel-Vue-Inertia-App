...
import {Link, useForm} from "@inertiajs/vue3";
 ...
 const props = defineProps({
  ...
  const form = useForm({
      ...
      stock: props.product.stock_quantity,
...
<template>
    <Head :title="`Edit ${product.name} details - `"/>
    <div class="bg-white p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-200">
            <div>
                <h1 class="text-3xl font-bold mb-4">Welcome to product editing Page</h1>
                <p class="text-gray-700">This is product editing page on the Inertia Challenge application.</p>
            </div>
            <div>
