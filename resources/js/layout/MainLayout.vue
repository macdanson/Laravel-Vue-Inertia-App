                ...
                <div class="flex gap-2">
                    <div class="dropdown dropdown-end">
                        <div role="button" class="flex items-center space-x-2 p-1" tabindex="0">
                            <!-- Avatar -->
                            <img class="w-10 h-10 rounded-full object-cover" src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp" alt="User avatar"/>
        ...
        <div class="drawer-side is-drawer-close:overflow-visible">
            ...
            <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                ...
                <ul class="menu w-full grow">
                    ...
                    <li>
                        <a href="/posts" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Posts">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
